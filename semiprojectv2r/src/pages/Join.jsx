...
const processJoinok = async (formValues) =>{
    ...
    // console.log(formValues.passwd.value);
...
const Join = () => {
    ...
    const validateJoinForm = (values) =>{
        ...
        if(!values.passwd ){
            ...
            formErrors.passwd = "비밀번호를 6자 이상 입력하세요";
        }
        ...
        if(!values.email){
            ...
            formErrors.email = "유효한 이메일 주소가 아닙니다";
        }
        return formErrors;
    };
    ...
    return (
        <main id="content">
            ...
            <form name="joinfrm" id="joinfrm" method="post"
                ...
                <div className="form-floating my-2">
                    <input type="password" name="repasswd" id="repasswd" className={`form-control ${errors.repasswd ? 'is-invalid' : ''}`}
                ...
                <div className="form-floating my-2">
                    <input type="text" name="name" id="name"className={`form-control ${errors.name ? 'is-invalid' : ''}`}
                ...
                <div className="form-floating my-2">
                    <input type="email" name="email" id="email" className={`form-control ${errors.email ? 'is-invalid' : ''}`}
